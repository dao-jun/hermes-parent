...
import org.apache.skywalking.apm.agent.plugin.AbstractClassEnhancePluginDefine;
import org.apache.skywalking.apm.agent.plugin.EnhanceContext;
import org.apache.skywalking.apm.agent.plugin.PluginException;
import org.apache.skywalking.apm.agent.plugin.bootstrap.BootstrapInstrumentBoost;
import org.apache.skywalking.apm.agent.plugin.interceptor.*;
...
public abstract class ClassEnhancePluginDefine extends AbstractClassEnhancePluginDefine {
     ...
     * New field name.
     */
    public static final String CONTEXT_ATTR_NAME = "_$EnhancedClassField_apm";
    ...
    private DynamicType.Builder<?> enhanceInstance(TypeDescription typeDescription,
        ...
        if (existedMethodsInterceptPoints) {
            for (InstanceMethodsInterceptPoint instanceMethodsInterceptPoint : instanceMethodsInterceptPoints) {
                ...
                if (StrUtil.isEmpty(interceptor)) {
