...
package org.apache.skywalking.apm.agent.plugin.bootstrap;
...
public class BootstrapInstrumentBoost {
    ...
    private static final String[] HIGH_PRIORITY_CLASSES = {
            "org.apache.skywalking.apm.agent.plugin.interceptor.enhance.BootstrapInterRuntimeAssist",
            "org.apache.skywalking.apm.agent.plugin.interceptor.enhance.InstanceMethodsAroundInterceptor",
            "org.apache.skywalking.apm.agent.plugin.interceptor.enhance.InstanceConstructorInterceptor",
            "org.apache.skywalking.apm.agent.plugin.interceptor.enhance.StaticMethodsAroundInterceptor",
            "org.apache.skywalking.apm.agent.plugin.bootstrap.IBootstrapLog",
    ...
    private static final String INSTANCE_METHOD_DELEGATE_TEMPLATE =
            "org.apache.skywalking.apm.agent.plugin.bootstrap.template.InstanceMethodInterTemplate";
    private static final String INSTANCE_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE =
            "org.apache.skywalking.apm.agent.plugin.bootstrap.template.InstanceMethodInterWithOverrideArgsTemplate";
    private static final String CONSTRUCTOR_DELEGATE_TEMPLATE =
            "org.apache.skywalking.apm.agent.plugin.bootstrap.template.ConstructorInterTemplate";
    private static final String STATIC_METHOD_DELEGATE_TEMPLATE =
            "org.apache.skywalking.apm.agent.plugin.bootstrap.template.StaticMethodInterTemplate";
    private static final String STATIC_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE =
            "org.apache.skywalking.apm.agent.plugin.bootstrap.template.StaticMethodInterWithOverrideArgsTemplate";
    ...
    private static void generateDelegator(Map<String, byte[]> classesTypeMap, TypePool typePool,
        ...
        try {
            ...
            DynamicType.Unloaded interceptorType = new ByteBuddy()
                    ...
                    .field(named("APM_TARGET_INTERCEPTOR")).value(methodsInterceptor)
                    .make();
