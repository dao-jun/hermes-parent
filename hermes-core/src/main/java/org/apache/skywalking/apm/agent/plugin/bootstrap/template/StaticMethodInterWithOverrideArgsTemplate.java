...
import org.apache.skywalking.apm.agent.plugin.interceptor.enhance.OverrideCallable;
...
public class StaticMethodInterWithOverrideArgsTemplate {
    ...
    public static Object intercept(@Origin Class<?> clazz, @AllArguments Object[] allArguments, @Origin Method method,
        ...
        InvokeContext result = new InvokeContext();
        try {
            if (INTERCEPTOR != null) {
        ...
        try {
            ...
            try {
                if (INTERCEPTOR != null) {
                    INTERCEPTOR.handleMethodException(clazz, method, allArguments, method.getParameterTypes(), t, result);
                }
            } catch (Throwable t2) {
            ...
            try {
                if (INTERCEPTOR != null) {
                    ret = INTERCEPTOR.afterMethod(clazz, method, allArguments, method.getParameterTypes(), ret, result);
                }
            } catch (Throwable t) {
